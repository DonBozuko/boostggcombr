 ...
 */
const ALLOW = new Set(["welcome", "optimized", "warning", "critical", "fail", "jarvis-interacao", "jarvis-pix", "jarvis-sucesso", "jarvis-instagram", "jarvis-tiktok", "jarvis-youtube", "jarvis-facebook", "jarvis-telegram", "jarvis-trafego", "jarvis-kwai"]);
