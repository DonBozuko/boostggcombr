          ...
          <Button
            ...
            onClick={async () => {
              try {
                ...
                toast.error("Falha na autenticação externa");
              }
            }}
            className="w-full h-11 bg-black/40 border-red-500/30 text-zinc-300 hover:text-white hover:bg-red-500/10 transition-all border-dashed"
          >
