      ...
      <div className="w-full max-w-[450px] mx-auto relative z-10">
        ...
        >
          ...
          <div className="relative flex items-center gap-3 py-1">
            ...
            <span className="text-[10px] text-zinc-500 uppercase tracking-widest">Acesso Biométrico / OAuth</span>
            <div className="flex-1 h-px bg-red-500/20" />
          </div>

          {/* v468: Blindagem de Segurança. O botão de Google Auth foi removido para evitar que usuários não autorizados
              tentem acessar o fluxo administrativo via OAuth externo, reforçando o login exclusivo via e-mail/senha
              e blindagem do Administrador-Mestre (fabiano.majestic@gmail.com). */}
          ...
          <p className="text-[10px] text-center text-zinc-600">
            Jarvis OS · v434 · RLS Ativo · MODO EXECUTOR
          </p>
        </form>
      </div>
    </div>
