...
export const Route = createFileRoute("/youtube")({
  head: () => {
    ...
    const ogImage = `https://eliteboostprime.lovable.app${ogYoutube}?v=33`;
    return {
      meta: [
        { title },
...
function YoutubeLanding() {
  ...
  return (
    ...
    <MobileFrame bg="#0a0a0a" route="/youtube">
      ...
      <div className="fixed z-[60] flex items-center gap-2" style={{ left: "max(8px, calc(50vw - 230px + 6px))", top: 6 }}><JarvisBadge variant="youtube" inline /><ShowcaseTrigger /></div>
      <ShowcaseShell>
      {/* HERO */}
      <div
      ...
      >
        <div className="container mx-auto px-6 h-12 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="size-7 rounded-full overflow-hidden ring-2 shadow-[0_0_12px_rgba(255,0,0,0.7)]" style={{ borderColor: "#FF0000" }}>
