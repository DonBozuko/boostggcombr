...
const buildSitemapXml = () => {
  const entries: SitemapEntry[] = [
    ...
    { path: "/blog/como-instagram-detecta-seguidores", changefreq: "monthly", priority: "0.6" },
    { path: "/blog/shadowban-mito-ou-realidade", changefreq: "monthly", priority: "0.6" },
    { path: "/blog/guia-bio-perfeita-instagram", changefreq: "monthly", priority: "0.6" },
    { path: "/blog/instagram-vs-tiktok-onde-crescer", changefreq: "monthly", priority: "0.6" },
    { path: "/blog/por-que-entrega-gradual-e-segura", changefreq: "monthly", priority: "0.6" },
    { path: "/blog/guia-seguranca-comprar-seguidores", changefreq: "monthly", priority: "0.6" },
    { path: "/blog/como-escolher-site-confiavel-seguidores", changefreq: "monthly", priority: "0.6" },
    { path: "/blog/potencializar-resultados-pos-compra", changefreq: "monthly", priority: "0.6" },
