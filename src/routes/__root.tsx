...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Comprar seguidores Instagram, TikTok e YouTube na BOOSTGG. Entrega rápida via Pix, perfis brasileiros e reposição garantida. 100% seguro e real." },
    ...
    scripts: [
      ...
      { src: "https://www.googletagmanager.com/gtag/js?id=G-9RBZGZTTMC", async: true },
      {
...
gtag('config', 'AW-16655771808');`,
  ...
  // v403 — o pixel do TikTok (~150 KB) era baixado antes da primeira tela.
  // A fila de eventos (ttq.track) já existe desde agora, então nada se perde:
  // só o download do arquivo espera o navegador ficar livre.
  var __ttqGo=function(){try{ttq.load('D97FQ2RC77U5KEVKK73G');ttq.page();}catch(e){}};
  if ('requestIdleCallback' in w) { w.requestIdleCallback(__ttqGo, { timeout: 4000 }); } else { setTimeout(__ttqGo, 2500); }
...

      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "BoostGG",
          legalName: "Elite Boost Prime",
          url: "https://www.boostgg.com.br",
          logo: "https://www.boostgg.com.br/og-instagram.jpg",
          image: "https://www.boostgg.com.br/og-instagram.jpg",
          description: "Comprar seguidores Instagram, TikTok e YouTube reais e brasileiros com entrega rápida via Pix.",
