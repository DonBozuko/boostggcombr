...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BoostGram — Seguidores Reais para Instagram" },
      { property: "og:description", content: "Pacotes de 1k, 3k e 5k seguidores. Entrega imediata após Pix." },
