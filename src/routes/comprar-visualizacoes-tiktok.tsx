...
const URL = "https://www.boostgg.com.br/comprar-visualizacoes-tiktok";
const TITLE = "Comprar Visualizações no TikTok via Pix | BoostGG";
const DESC =
...
export const Route = createFileRoute("/comprar-visualizacoes-tiktok")({
  head: () => ({
    ...
    scripts: [buildFaqJsonLd(FAQ), buildProductJsonLd({ network: "TikTok", url: URL, description: DESC }), buildBreadcrumbJsonLd([{ name: "Início", url: "https://www.boostgg.com.br/" }, { name: "Visualizações TikTok", url: URL }])],
  }),
  component: Page,
});
