...
export const Route = createFileRoute("/status")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Monitoramento em tempo real das redes sociais e webhooks da BoostGG." },
  ...
  return (
    <div style={{ background: "#0a0a0a", minHeight: "100vh", color: "#fff", padding: "40px 20px", fontFamily: "system-ui, sans-serif" }}>
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <p style={{ opacity: 0.6, marginBottom: 24 }}>Integridade em tempo real — BoostGG</p>
