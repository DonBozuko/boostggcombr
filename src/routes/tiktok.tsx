...
function TiktokLanding() {
  ...
  return (
    ...
    <MobileFrame bg="#0a0a0a" route="/tiktok">
      ...
      <JarvisBladeBadge variant="tiktok" />
      <SantiagoBadge variant="tiktok" />
      <ShowcaseShell>
      <div
      ...
      >
        <div className="container mx-auto px-6 h-12 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="size-7 rounded-full overflow-hidden ring-2 shadow-[0_0_12px_rgba(0,242,254,0.7)]" style={{ borderColor: "#00f2fe" }}>
