...
export const Route = createFileRoute("/tiktok")({
  head: () => {
    ...
    const ogImage = `https://www.boostgg.com.br${ogTiktok}?v=48`;
    return {
      meta: [
        { title },
      ...
      scripts: [buildProductJsonLd({ network: "TikTok", category: "Seguidores e Views", url, description }), buildFaqJsonLd(FAQS["tiktok"])],
    };
  },
  ...
  return (
    ...
    <MobileFrame bg="#0a0a0a" route="/tiktok">
      ...
      <h1 className="text-center text-2xl sm:text-3xl font-bold text-white mt-4 mb-2 px-4">
        Turbinar TikTok — Seguidores, Curtidas e Views
      </h1>
      <ShowcaseShell>
